...
namespace Fermion
{
    ...
    void InspectorPanel::deliverPickedEntity(Entity pickedEntity)
    {
        ...
        m_pickingTargetEntity = {};
    }

    void InspectorPanel::cancelEntityPicking()
    {
        m_entityPickingActive = false;
        m_pickingTargetEntity = {};
    }
    ...
    void InspectorPanel::drawComponents(Entity entity)
    {
        ...
        drawComponent<RevoluteJoint2DComponent>("Revolute Joint 2D", entity, [this, entity](auto &component)
            ...
            if (m_entityPickingActive && m_pickingTargetEntity == entity)
            {
                ...
                if (ImGui::Button("Picking... (Click entity in viewport)"))
                {
                    cancelEntityPicking();
                }
            ...
            {
                if (ImGui::Button("Pick Connected Body"))
                {
            ...
            ui::drawFloatControl("Lower Angle", component.lowerAngle, 150.0f, 0.01f, -6.28f, 6.28f);
            ui::drawFloatControl("Upper Angle", component.upperAngle, 150.0f, 0.01f, -6.28f, 6.28f);
            ImGui::Separator();
