...
public:
    ...
    static void InitGlobal(const RendererConfig& config);
    static void ShutdownGlobal();
    static Renderer2D& Get();
    static Renderer2D* TryGet();
    ...
    void drawQuadBillboard(const glm::vec3& position,
                           const glm::vec2& size,
    ...
    void drawQuadInstanced(const glm::mat4& transform,
                           const glm::vec4& color,
                           const std::shared_ptr<Texture2D>& texture,
                           float tilingFactor,
                           int objectID);
    ...
    void drawLine(const glm::vec3& p0,
                  const glm::vec3& p1,
                  const glm::vec4& color,
                  int objectId = -1);
...
private:
    ...
    void updateCameraUBO(const glm::mat4& viewProj,
                         const glm::mat4& view,
