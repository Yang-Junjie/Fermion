...
namespace Fermion
{
    ...
    public:
        ...
        static void drawRotatedQuad(const glm::vec2 &position, const glm::vec2 &size, float angle, const std::shared_ptr<Texture2D> &texture, float tilingFactor = 1.0f, glm::vec4 tintColor = glm::vec4(1.0f));
        static void drawRotatedQuad(const glm::vec3 &position, const glm::vec2 &size, float angle, const std::shared_ptr<Texture2D> &texture, float tilingFactor = 1.0f, glm::vec4 tintColor = glm::vec4(1.0f));
