...
class ScriptClass {
public:
    ScriptClass(const std::string &ns, const std::string &name) : m_classNamespace(ns), m_className(name) {
    }
...
public:
    ScriptInstance(std::shared_ptr<ScriptClass> scriptClass, Entity entity) : m_scriptClass(scriptClass) {
    ...
    std::shared_ptr<ScriptClass> getScriptClass() const {
