...
CSharpScriptClass::CSharpScriptClass(MonoDomain *domain, MonoClass *klass, const std::string &ns, const std::string &name) : ScriptClass(ns, name), m_domain(domain), m_class(klass) {
    // 缓存所有公共字段
    void *iter = nullptr;
