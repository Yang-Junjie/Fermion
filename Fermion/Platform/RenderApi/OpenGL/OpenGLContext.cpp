...
namespace Fermion
{
    ...
    void OpenGLContext::init()
    {
        ...
        m_deviceInfo.renderer = std::string(reinterpret_cast<const char *>(glGetString(GL_RENDERER)));
        m_deviceInfo.vendor = std::string(reinterpret_cast<const char *>(glGetString(GL_VENDOR)));
        m_deviceInfo.version = std::string(reinterpret_cast<const char *>(glGetString(GL_VERSION)));
